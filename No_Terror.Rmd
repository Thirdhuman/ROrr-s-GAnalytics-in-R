...
```{r include=FALSE, message=FALSE, warning = FALSE, fig.height=9, fig.width=8.5}

knit: (function(No_Terror.rmd, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0(analysis_identifier,'.pdf'))) })

#rmarkdown::render(output_file=paste0(analysis_identifier,".pdf"))
```
\pagebreak
