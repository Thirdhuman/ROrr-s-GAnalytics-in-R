...
library(knitr)
library(tinytex)
rmarkdown::render(input = "/Users/rorr/Desktop/Welfare_Policy/Data/Data_Explorations/Google_Analytics(Cato)Generalized_Output.Rmd", pdf_document(output_file = "string.pdf")
																		)

# 
# knit("Generalized_Output.Rmd")
# markdownToHTML('Generalized_Output.md', paste0(analysis_identifier,'.html'), options=c("use_xhml"))
# system(paste0("pandoc -s ",analysis_identifier,'.html -o ',analysis_identifier,".pdf"))
#rmarkdown::render("Generalized_Output.Rmd", run_pandoc=T, encoding = getOption("encoding"), output_file = paste0(analysis_identifier,'.pdf'))
```
...
total_line$big_day <- ifelse(total_line$sessions > 2000, paste0(total_line$title,"(",as.character(total_line$obs_day),")"), "")
